...
services = {
        ...
        'Webflow'         : {'error':r'The page you are looking for doesn\'t exist or has been moved'},
        ...
        'Flywheel'        : {'error':r'Oops!'},
        'Acquia'          : {'error':r'Web Site Not Found'},
        'Agile CRM'       : {'error':r'this page is no longer available'},
        'Anima'           : {'error':r'try refreshing in a minute'},
        'CampaignMonitor' : {'error':r'Trying to access your account'},
        'Cargocollective' : {'error':r'404 Not Found'},
        'Fly.io'          : {'error':r'404 Not Found'},
        'Gemfury'         : {'error':r'This page could not be found'},
        'HatenaBlog'      : {'error':r'404 Blog is not found'},
        'heroku'          : {'error':r'No such app'},
        'Intercom'        : {'error':r'That page doesn\'t exist'},
        'Kinsta'          : {'error':r'No Site For Domain'},
        'Landingi'        : {'error':r'It looks like'},
        'LaunchRock'      : {'error':r'It looks like you may have taken a'},
        'Ngrok'           : {'error':r'Tunnel *.ngrok.io not found'},
        'Pantheon'        : {'error':r'404 error unknown site!'},
        'Pingdom'         : {'error':r'Sorry, couldn\'t find the status page'},
        'SmartJobBoard'   : {'error':r'This job board website is either'},
        'Strikingly'      : {'error':r'page not found'},
        'Tumblr'          : {'error':r'Whatever you were looking for'},
        'Tilda'           : {'error':r'Please renew your subscription'},
        'Uberflip'        : {'error':r'Non-hub domain'},
